...
// VYSVETLENIE
public class Priklad02BigDecimalOperacieRiesenie {
	...
	public static void main(String[] args) {
		...
		System.out.println( cislo + " - " + druhe + " = " + cislo.subtract(druhe) );	// TODO subtract
		System.out.println( cislo + " x " + druhe + " = " + cislo.multiply(druhe) );	// TODO multiply
		System.out.println( cislo + " / " + druhe + " = " + cislo.divide(druhe) );	// TODO divide
