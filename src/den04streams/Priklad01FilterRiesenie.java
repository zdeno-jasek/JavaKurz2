...
// Vysvetlenie
public class Priklad01FilterRiesenie {
	...
	public static void main(String[] args) {
		...
		// TODO: mená, ktoré majú "a" druhé v poradí (Pavol, Gabriela, Natasa)
		Collection<String> menaMajuADruhe = mena.stream()
				.filter( meno -> meno.charAt(1) == 'a' )
				.toList();
		
		System.out.println( "Vybraný zoznam mien " + menaMajuADruhe );
		
		// TODO: mená, ktoré obsahujú aspoň jedno "e" (Jozef, Peter, Gabriela)
		Collection<String> menaMajuE = mena.stream()
				.filter( meno -> meno.indexOf('e') > -1 )
				.toList();
		
		System.out.println( "Vybraný zoznam mien " + menaMajuE );
	}
}
