...
// Vysvetlenie
public class Priklad05MapRiesenie {
	...
	public static void main(String[] args) {
		...
		Optional<String> menaVelkymiPismenamiJ = mena.stream()
				.filter( meno -> meno.charAt(0) == 'J' || meno.charAt(0) == 'P' )
				.map( meno -> meno.toUpperCase() )
				.reduce( (meno1, meno2) -> meno1 + " a " + meno2 );
		System.out.println( "Vybraný zoznam mien " + menaVelkymiPismenamiJ.get() );
		// JOZEF, JURAJ
	}
}
